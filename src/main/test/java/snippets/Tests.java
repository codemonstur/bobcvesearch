...
//        NvdModel model = downloadNewDatabaseEntries("modified");
//        for (final var cve : model.CVE_Items) {
//            List<String> cpEs = cve.getCPEs();
//            System.out.println("Number of CPEs for " + cve.getID() + " is " + cpEs.size());
//        }
